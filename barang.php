                    ...
                    <?php if ($result->num_rows > 0) { ?>
                      <?php while ($row = $result->fetch_assoc()) { ?>
                        <tr>
                          ...
                          <?php if (isset($_SESSION['status']) == 'login') { ?>
                            <th>
                              <a href="editbarang.php?id_har=<?= $row['id_har'] ?>" class="btn btn-danger text-center p-1  ">edit </a>
                              <a href="hapusbarang.php?id_har=<?= $row['id_har'] ?>" class="btn btn-primary text-center p-1">hapus</a>
                            </th>
                          <?php } ?>
                          <?php $no++ ?>
                        </tr>
