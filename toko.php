                    ...
                    <?php if ($result->num_rows > 0) { ?>
                      <?php while ($row = $result->fetch_assoc()) { ?>
                        <tr>
                          ...
                          <?php if (isset($_SESSION['status']) == 'login') { ?>
                            <th>
                              <a href="edittoko.php?id_toko=<?= $row['id_toko'] ?>" class="btn btn-danger text-center p-1">edit </a>
                              <a href="hapustoko.php?id_toko=<?= $row['id_toko'] ?>" class="btn btn-primary text-center p-1">hapus</a>
                            </th>
                          <?php } ?>
                          <?php $no++ ?>
                        </tr>
